            ...
            <div className="container">
                <div className="row">
                    <div className="">
                        ...
                        <h2>Poland</h2>
                        <p>With over 1,000 public hospitals and 400 private hospitals, Poland is recognized as one of the world's leading destinations for medical tourism. More than 1.4 million medical tourists are treated in Poland hospitals and clinics each year.</p>
                        <p>The Poland medical system has experience treating a range of medical conditions: the most common procedures include dental treatments, plastic and cosmetic surgery, as well as orthopedic surgery (knee and hip replacements), gender reassignment surgery, and heart surgery. Wrocław, Warszawa, and Krakw cater to visitors who are eager to discover the country's lush natural resources and rich cultural traditions.</p>
